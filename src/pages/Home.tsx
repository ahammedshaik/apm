  ...
  return (
    <div>
      ...
      <HeroSection 
        ...
        subtitle="APM & IQRA Construction Experts - Your trusted partner for residential, commercial, and government construction projects."
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="md:w-1/2">
              <h2 className="text-3xl font-bold mb-4">About APM & IQRA Construction</h2>
              <p className="text-gray-600 mb-4">
                With over a decade of experience in the construction industry, APM & IQRA Construction Experts has established itself as one of the leading construction companies in Hyderabad. We specialize in residential, commercial, and government construction projects.
              </p>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <TestimonialCard 
              quote="APM & IQRA Construction delivered our dream home exactly as we envisioned. Their attention to detail and quality of work is exceptional."
              name="Rajesh Kumar"
              title="Homeowner"
              image="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=774&q=80"
            />
            <TestimonialCard 
              quote="Working with APM & IQRA for our office building was a seamless experience. They completed the project on time and within budget."
              name="Priya Sharma"
              title="CEO, TechSolutions"
              image="https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=774&q=80"
            />
            <TestimonialCard 
              quote="The municipal project handled by APM & IQRA Construction was executed with utmost professionalism and adherence to all regulations."
              name="Suresh Reddy"
