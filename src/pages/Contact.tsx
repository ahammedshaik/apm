          ...
          <div className="max-w-3xl mx-auto">
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <p className="text-gray-600">
                  Yes, APM Constructions is fully licensed and insured. We maintain all necessary certifications and insurance coverage to protect our clients and projects.
                </p>
              </div>
            </div>
          </div>
